...
var none = 'none'
path_mascaras="https://raw.githubusercontent.com/jcastillovnz/ORBITAL-360/master/iframes/r6/assets/img/r6/masks/"
path_highlights_blue="assets/img/r6/highlights/blue/"
path_highlights_red="assets/img/r6/highlights/red/"
extencion=".png"
html += '<img class="threesixty-frame" style="display:' +display + ';" data-index="' + i + '"  id="' + i + '" src="' + pathTemplate.replace('{index}', i) + '"/>';
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
html += '<img class="masks" alt="'+i+'" crossOrigin = "Anonymous"  style="display:' + display + ';" id="true"     data-index="' + i + '"   src="' + path_mascaras+''+i+extencion+'"/>';
